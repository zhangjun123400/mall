...
public class MyBatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        String jdbcUrl = "jdbc:mysql://localhost:3306/mall?useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai";
        ...
        GlobalConfig gc = new GlobalConfig.Builder()
                .outputDir(System.getProperty("user.dir") + "/mall-mbg/src/main/java") // 输出路径
